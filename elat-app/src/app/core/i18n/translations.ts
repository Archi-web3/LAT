export const TOP_LEVEL_TRANSLATIONS = {
    EN: {
        ...
        COMMON: {
            ...
            ASSESSMENTS_DASHBOARD: 'Assessments Dashboard',
            STATUS: 'Status',
            DATE: 'Date',
            SCORE: 'Score',
            ACTIONS: 'Actions',
    ...
    FR: {
        ...
        COMMON: {
            ...
            VALIDATE: 'Valider',
            BACK: 'Retour',
            VALIDATE_AND_EXIT: 'Enregistrer & Quitter',
            USER: 'Utilisateur',
            ROLE: 'Rôle',
            AUTHOR: 'Auteur',
            MONTH: 'Mois',
            SYNC_STATUS: 'Sync Statut',
            LAST_UPDATE: 'Dernière MAJ',
            ASSESSMENTS_DASHBOARD: 'Tableau de bord Évaluations',
            STATUS: 'Statut',
            DATE: 'Date',
            SCORE: 'Score',
            ACTIONS: 'Actions',
